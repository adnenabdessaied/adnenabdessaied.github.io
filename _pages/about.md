...
I did a PhD at the University of Stuttgart, Germany, under the supervision of [Andreas Bulling](https://scholar.google.de/citations?hl=de&user=QURZIzUAAAAJ&view_op=list_works&sortby=pubdate), where I focused on multi-modal models at the intersection of computer vision and natural language processing. Specifically, I developed novel VLMs specifically geared towards conversational tasks such as visual and video dialog.
